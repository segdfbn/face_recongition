...
pose_predictor_68_point = dlib.shape_predictor(
    os.path.join(PATH_MODELS, "shape_predictor_68_face_landmarks.dat"))
pose_predictor_5_point = dlib.shape_predictor(
    os.path.join(PATH_MODELS, "shape_predictor_5_face_landmarks.dat"))
face_encoder = dlib.face_recognition_model_v1(
    os.path.join(PATH_MODELS, "dlib_face_recognition_resnet_model_v1.dat"))
...
def easy_face_reco(frame, known_face_encodings, known_face_names):
    ...
    for face_encoding in face_encodings_list:
        ...
        print(f"Nombre de visages connus chargés : {len(known_face_encodings)}")
...
if __name__ == '__main__':
    ...
    known_face_names = ['bradpit','seghira','seghira1']
